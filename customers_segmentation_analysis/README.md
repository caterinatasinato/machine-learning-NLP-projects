...
4. **Cluster 3**: Low spending, frequent cash advances, low full payment rate (high risk) 
...
3. **Cluster 0 & Cluster 3**: These are high-risk customers. Introduce financial management tools and flexible payment plans to help reduce risk. 
